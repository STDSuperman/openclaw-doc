...
# 查看 WhatsApp 私聊详情
openclaw sessions get --session "agent:main:whatsapp:dm:+86999999900"
...
会话 Key: agent:main:whatsapp:dm:+86999999900
...
```bash
# 删除特定会话
openclaw sessions delete --session "agent:main:whatsapp:dm:+86999999900"
...
# 压缩特定会话
openclaw compact --session "agent:main:whatsapp:dm:+86999999900"
...
```bash
# 查看会话的完整处理日志
openclaw sessions get --session "agent:main:whatsapp:dm:+86999999900" --verbose
```
